...
Details on the reference files used for analyses, and their download links can be found [here](https://github.com/mitenjain/NA12878/blob/master/nanopore-human-transcriptome/reference.md)
